...
let abs = box (fun (x: obj) -> box (abs (unbox<float> x)))
...
let max = box (fun (n1: obj) -> box (fun (n2: obj) -> box (max (unbox<float> n1) (unbox<float> n2))))
let min = box (fun (n1: obj) -> box (fun (n2: obj) -> box (min (unbox<float> n1) (unbox<float> n2))))
