    ...
    return function (l) {
        return $foreign.runST(function __do() {
            ...
            Control_Monad_ST_Internal.foreach(Data_Array.fromFoldable(dictFoldable)(l))(function (v) {
                return Data_Function.apply($$void)(Foreign_Object_ST.poke(v.value0)(v.value1)(s));
            })();
            return s;
        });
    };
...
var $lazy_traversableObject = /* #__PURE__ */ $runtime_lazy("traversableObject", "Foreign.Object", function () {
    return {
        traverse: function (dictApplicative) {
            var $69 = Data_TraversableWithIndex.traverseWithIndex($lazy_traversableWithIndexObject(0))(dictApplicative);
            return function ($70) {
                return $69(Data_Function["const"]($70));
            };
        },
        sequence: function (dictApplicative) {
            return Data_Traversable.traverse($lazy_traversableObject(0))(dictApplicative)(identity);
        },
        Functor0: function () {
            return functorObject;
        },
...
var $lazy_traversableWithIndexObject = /* #__PURE__ */ $runtime_lazy("traversableWithIndexObject", "Foreign.Object", function () {
    return {
        ...
        Traversable2: function () {
            return $lazy_traversableObject(0);
        }
    };
});
var traversableObject = /* #__PURE__ */ $lazy_traversableObject(127);
var traversableWithIndexObject = /* #__PURE__ */ $lazy_traversableWithIndexObject(131);
...
var filterKeys = function (predicate) {
    return Data_Function.apply(filterWithKey)(function ($71) {
        return Data_Function["const"](predicate($71));
    });
};
var filter = function (predicate) {
    return Data_Function.apply(filterWithKey)(Data_Function["const"](predicate));
};
